...
const socialIcons = [
  { icon: <FacebookIcon className="w-3.5 h-3.5 sm:w-3 sm:h-3" />, label: "Facebook" },
  { icon: <InstagramIcon className="w-3.5 h-3.5 sm:w-3 sm:h-3" />, label: "Instagram" },
  { icon: <LinkedInIcon className="w-3.5 h-3.5 sm:w-3 sm:h-3" />, label: "LinkedIn" },
  { icon: <YoutubeIcon className="w-3.5 h-3.5 sm:w-3 sm:h-3" />, label: "YouTube" },
];
            ...
            <div className="space-y-3 sm:space-y-2.5">
              <div className="flex items-center gap-1.5 p-1 rounded-sm bg-white/5 border border-white/10 w-full sm:w-fit">
                <button
                  ...
                  className={`flex-1 sm:flex-none px-3 py-1.5 sm:py-1 rounded-sm text-xs sm:text-[11px] font-medium transition-all text-center ${
                    activeTab === "services"
              ...
              <div className="flex items-start gap-2.5 sm:gap-2">
                ...
                <div>
                  ...
                  <p className="text-slate-300/80 text-xs sm:text-[10px] font-light leading-relaxed sm:leading-normal">
                    406, 4th Floor, GIDC, Sector-11, Gandhinagar, Gujarat - 382011, India
                  </p>
                </div>
              </div>
              <a
