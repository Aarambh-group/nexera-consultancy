...
const faqs = [
  {
    question: "Do I need an official invitation letter for a visitor visa?",
    answer:
      "If you are visiting family or friends, a formal invitation letter with proof of their residence status (PR, Citizenship, or Work Permit) significantly strengthens your application. We assist hosts in drafting standard letters.",
  },
  {
    question: "How much bank balance is required for a visitor visa?",
    answer:
      "Requirements depend on the destination, duration of stay, and whether your host is sponsoring your stay. Generally, you must demonstrate sufficient funds to cover travel, accommodation, and personal expenses.",
  },
  {
    question: "What are 'Home Country Ties' and why are they important?",
    answer:
      "Embassies want assurance that you will return home after your visit. Strong ties include permanent employment, property ownership, business investments, or immediate family members residing in your home country.",
  },
  {
    question: "How long does visitor visa processing usually take?",
    answer:
      "Processing times vary by destination, ranging from 2 to 6 weeks. We advise filing applications at least 6 to 8 weeks before your planned departure date.",
  },
];
