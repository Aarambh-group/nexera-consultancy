...
const benefitsList = [
  {
    ...
    desc: "Triple-layer document checks to eliminate spelling errors, missing forms, or wrong formats.",
  },
  {
    icon: Shield,
    title: "Embassy Compliant",
    desc: "Strict adherence to updated checklists provided by global consulates and visa centers.",
  },
  {
    icon: FileText,
    title: "Custom Cover Letters",
    desc: "Professionally drafted cover letters articulating your travel purpose and ties convincingly.",
  },
  {
    icon: Lock,
    title: "100% Data Security",
    desc: "Encrypted document management ensuring total confidentiality of sensitive personal and financial data.",
  },
];
...
export default function WhyChooseUs() {
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-white font-sans selection:bg-[#E5A64C] selection:text-[#0A1329]">
      {/* Aligned container matching standard 7xl layout */}
