...
export default function Hero() {
  return (
    <section
      ...
      style={{ backgroundImage: "url('/images/tourist-bg.png')" }}
    >
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 w-full">
        <div className="max-w-xl space-y-4 sm:space-y-5">
          ...
          >
            ...
            <span className="text-[#E5A64C] font-semibold">Tourist Visa</span>
          </motion.div>
          ...
          >
            ...
            Confidence through{" "}
            <span className="italic font-normal text-[#E5A64C]">Tourist Visa</span>
            <br />
            Expertise
          </motion.h1>
          ...
          >
            Planning an international vacation, honeymoon, or holiday? We handle documentation, travel itineraries, and visa filings so you can focus on enjoying your journey.
          </motion.p>
