...
import { Briefcase, FileText, CheckCircle2, Send, Award } from "lucide-react";
...
const steps = [
  {
    ...
    desc: "Understanding event details, host invitation, and travel timeline.",
  },
  {
    icon: FileText,
    title: "Invitation Audit",
    desc: "Verifying corporate invitations and dispatch letter specifications.",
  },
  {
    icon: CheckCircle2,
    title: "Document Assembly",
    desc: "Preparing company bank records, tax filings, and travel schedules.",
  },
  {
    icon: Send,
    title: "Consular Submission",
    desc: "Booking priority appointments and processing embassy forms.",
  },
  {
    icon: Award,
    title: "Visa Issuance",
    desc: "Receiving your business visa and travel compliance briefing.",
  },
];

export default function BusinessProcess() {
  return (
    <section className="py-8 sm:py-12 lg:py-16 bg-slate-50/70 font-sans selection:bg-[#E5A64C] selection:text-[#0A1329] overflow-hidden">
      {/* Aligned container matching design system standards */}
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 w-full space-y-8 sm:space-y-10 text-center">
