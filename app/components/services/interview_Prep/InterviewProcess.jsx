...
import { FileSearch, MessageSquare, Video, RefreshCw, Award } from "lucide-react";
...
const steps = [
  {
    ...
    desc: "Reviewing your application, financial background, and red-flag areas.",
  },
  {
    icon: MessageSquare,
    title: "2. Question Customization",
    desc: "Designing tailored answers aligned with your specific destination.",
  },
  {
    icon: Video,
    title: "3. Simulated Mock 1",
    desc: "First intensive mock session under realistic consular pressure.",
  },
  {
    icon: RefreshCw,
    title: "4. Feedback & Refinement",
    desc: "Analyzing body language, response clarity, and document presentation.",
  },
  {
    icon: Award,
    title: "5. Final Polish & Readiness",
    desc: "Final confidence booster drill to ensure absolute interview readiness.",
  },
];
