...
const benefitsList = [
  {
    ...
    desc: "Rigorous verification of itineraries and financials to maximize approval outcomes.",
  },
  {
    icon: Target,
    title: "Tailored Travel Plans",
    desc: "Custom documentation structured to fit vacations, honeymoons, or family trips.",
  },
  {
    icon: Award,
    title: "Experienced Specialists",
    desc: "Dedicated advisors up-to-date with evolving consulate and embassy rules.",
  },
  {
    icon: Clock,
    title: "Prompt File Processing",
    desc: "Swift file turnaround ensuring your visa application is submitted well before departure.",
  },
];
